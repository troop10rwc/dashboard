...
// /dashboard SSR shell (src/worker/index.ts) into <div id="root">. Uses the same
// @troop10rwc/ui AppShell as every other back-office page so the chrome (top bar,
// sidebar, tokens) stays identical. CSS order per STYLE.md: fonts FIRST, then the
// --t10-* token theme.
...
function Dashboard() {
  ...
  // root-relative hrefs (/manage/<app>) resolve directly — no origin rewrite.
